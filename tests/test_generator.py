...
from qageneratorllm.qa_dataclass import QABank, MCQBank
...
def test_invoke_qa(mock_chat, sample_context, sample_qa_response):
    mock_chat.return_value.with_structured_output.return_value.invoke.return_value = QABank(**sample_qa_response)
...
def test_invoke_mcq(mock_chat, sample_context, sample_mcq_response):
    mock_chat.return_value.with_structured_output.return_value.invoke.return_value = MCQBank(**sample_mcq_response)
